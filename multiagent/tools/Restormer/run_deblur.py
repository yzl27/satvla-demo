...
############################################################
# 🔧 USER CONFIGURATION (去模糊配置)
############################################################
DEFAULTS = dict(
    task="Motion_Deblurring", 
    input_dir="/home/990ep/wcj_datasets/HRSC_png/100000000.png",
    result_dir="./outputs/deblurred/",
    weight_path=os.path.join(os.path.dirname(os.path.abspath(__file__)), "weights", "motion_deblurring.pth"),
    device="cuda",
    tile=None,
    tile_overlap=32
)
...
def main():
    ...
    parameters = {
        ...
        "bias": False,
        "LayerNorm_type": "WithBias",  # 去模糊为 WithBias
